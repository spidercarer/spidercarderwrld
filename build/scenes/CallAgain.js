...
exports.callAgainScene = new telegraf_1.Scenes.WizardScene('CALL_AGAIN_ID', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            case 0:
                ...
                ctx.scene.state && ctx.scene.state.callData
                    ...
                    }, number = _a.number, institutionName = _a.institutionName;
                if (!(!number || !institutionName)) return [3 /*break*/, 2];
            ...
            case 2:
                from = constants_1.UK_NUM_REGEX.test(number)
                    ? process.env.UK_NUM
                    : process.env.US_NUM;
                return [4 /*yield*/, ctx.replyWithHTML('<i>Calling again in 20 seconds</i>')];
            case 3:
                _b.sent();
                setTimeout(function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, ctx.reply("Calling " + number + "\nfrom " + from + " as:\n\n" + institutionName + " \uD83D\uDCF2...")];
                            case 1:
                                _a.sent();
