...
var coinbase_1 = require("../utils/coinbase");
exports.buyScene = new telegraf_1.Scenes.WizardScene('BUY_ID', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var coinbaseCharge;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, coinbase_1.createCharge('OTP', "OTP Buying", process.env.OTP_PRICE, (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id, (_b = ctx.chat) === null || _b === void 0 ? void 0 : _b.id, 'OTP Purchase')];
            case 1:
                coinbaseCharge = _c.sent();
                return [4 /*yield*/, ctx.replyWithHTML('💱 <b>Select the currency you would like to pay with</b>\n\nWe will send you the address to pay to.\n\nYou can always come back up to chosoe another currency if you have selected the wrong one', telegraf_1.Markup.inlineKeyboard([
